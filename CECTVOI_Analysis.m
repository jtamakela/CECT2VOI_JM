...
filename = filename(7).name; %Reads the numbered last mat file
load(filename);
...
% % % % % % % % % % for location = 1:size(CECT_all,1) %How many measured locations
    location = 3; %There should be a six of these for the ponies
...
% % % % % % %     Let's go first with the 50 kV % % % % % % % % % % % % % % 
    ...
    while slider_question < 3
        ...
        % ÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖ
        % This is to orient
% % % % % % % % %         fit_coefficients = find_orientation(CECT90{location,timepoint});
        %ÄÖÄÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖÄÖ
